...
>>>>>>> 6f8fab9ee20e9c26d707603155d0e2565f492358
    ...
    `;let t=this.querySelector(".back-home-button");t?.addEventListener("click",e=>{e.preventDefault(),e.target,X.go("/live-chat"+"/")})}}customElements.define("chatrooms-page",en);var er={};er=new URL("send-icon2.da343077.png",import.meta.url).toString();class eo extends HTMLElement{constructor(){super()}connectedCallback(){this.render()}render(){var t=window.location.pathname.split("/")[2];this.innerHTML=`
    <style>
